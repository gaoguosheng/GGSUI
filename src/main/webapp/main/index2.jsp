		...
		<ul class="nav pull-right">
                    <li class="dropdown">
                        ...
                        <ul id="themeUl" class="dropdown-menu">
                            <li class="${sessionScope.theme=="default"?"active":""}"><a role="menuitem" tabindex="-1" href="index2.jsp?theme=default">default</a></li>
                            <li class="${sessionScope.theme=="cerulean"?"active":""}"><a href="index2.jsp?theme=cerulean">cerulean</a></li>
                            <li class="${sessionScope.theme=="united"?"active":""}"><a href="index2.jsp?theme=united">united</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
